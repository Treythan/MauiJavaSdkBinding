...
// Type: Com.Zebra.Commoniolib.IUsbSerialDriverInvoker
...
{
  [Register("com/zebra/commoniolib/UsbSerialDriver", DoNotGenerateAcw = true)]
  internal class IUsbSerialDriverInvoker : 
    ...
    IJavaPeerable
  {
    private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/commoniolib/UsbSerialDriver", typeof (IUsbSerialDriverInvoker));
    ...
    {
      return JNIEnv.IsInstanceOf(handle, IUsbSerialDriverInvoker.java_class_ref) ? handle : throw new InvalidCastException("Unable to convert instance of type '" + JNIEnv.GetClassNameFromInstance(handle) + "' to type 'com.zebra.commoniolib.UsbSerialDriver'.");
    }
