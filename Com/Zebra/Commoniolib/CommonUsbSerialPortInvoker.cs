...
// Type: Com.Zebra.Commoniolib.CommonUsbSerialPortInvoker
...
namespace Com.Zebra.Commoniolib
{
  ...
  {
    private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/commoniolib/CommonUsbSerialPort", typeof (CommonUsbSerialPortInvoker));
    ...
    public override unsafe IUsbSerialDriver? Driver
    {
      ...
      {
        JniObjectReference jniObjectReference = CommonUsbSerialPortInvoker._members.InstanceMethods.InvokeAbstractObjectMethod("getDriver.()Lcom/zebra/commoniolib/UsbSerialDriver;", (IJavaPeerable) this, (JniArgumentValue*) null);
