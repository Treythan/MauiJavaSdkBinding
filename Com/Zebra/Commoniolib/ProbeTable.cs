...
// Type: Com.Zebra.Commoniolib.ProbeTable
...
{
  [Register("com/zebra/commoniolib/ProbeTable", DoNotGenerateAcw = true)]
  public class ProbeTable : Object
  {
    private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/commoniolib/ProbeTable", typeof (ProbeTable));
    ...
    [Register("addProduct", "(IILjava/lang/Class;)Lcom/zebra/commoniolib/ProbeTable;", "GetAddProduct_IILjava_lang_Class_Handler")]
    public virtual unsafe ProbeTable? AddProduct(int vendorId, int productId, Class? driverClass)
    {
      try
      {
        ...
        JniObjectReference jniObjectReference = ProbeTable._members.InstanceMethods.InvokeVirtualObjectMethod("addProduct.(IILjava/lang/Class;)Lcom/zebra/commoniolib/ProbeTable;", (IJavaPeerable) this, jniArgumentValuePtr);
