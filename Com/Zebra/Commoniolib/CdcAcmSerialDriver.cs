...
// Type: Com.Zebra.Commoniolib.CdcAcmSerialDriver
...
{
  [Register("com/zebra/commoniolib/CdcAcmSerialDriver", DoNotGenerateAcw = true)]
  public class CdcAcmSerialDriver : Object, IUsbSerialDriver, IJavaObject, IDisposable, IJavaPeerable
  {
    private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/commoniolib/CdcAcmSerialDriver", typeof (CdcAcmSerialDriver));
    ...
    [Register("com/zebra/commoniolib/CdcAcmSerialDriver$CdcAcmSerialPort", DoNotGenerateAcw = true)]
    public class CdcAcmSerialPort : CommonUsbSerialPort
    {
      private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/commoniolib/CdcAcmSerialDriver$CdcAcmSerialPort", typeof (CdcAcmSerialDriver.CdcAcmSerialPort));
      ...
      [Register(".ctor", "(Lcom/zebra/commoniolib/CdcAcmSerialDriver;Landroid/hardware/usb/UsbDevice;I)V", "")]
      ...
      {
        [Register("getDriver", "()Lcom/zebra/commoniolib/UsbSerialDriver;", "GetGetDriverHandler")] get
        {
          JniObjectReference jniObjectReference = CdcAcmSerialDriver.CdcAcmSerialPort._members.InstanceMethods.InvokeVirtualObjectMethod("getDriver.()Lcom/zebra/commoniolib/UsbSerialDriver;", (IJavaPeerable) this, (JniArgumentValue*) null);
    ...
    [Register("com/zebra/commoniolib/CdcAcmSerialDriver$UsbId", DoNotGenerateAcw = true)]
    public sealed class UsbId : Object
    {
      ...
      private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/commoniolib/CdcAcmSerialDriver$UsbId", typeof (CdcAcmSerialDriver.UsbId));
