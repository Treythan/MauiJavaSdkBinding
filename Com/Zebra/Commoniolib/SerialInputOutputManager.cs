...
// Type: Com.Zebra.Commoniolib.SerialInputOutputManager
...
{
  [Register("com/zebra/commoniolib/SerialInputOutputManager", DoNotGenerateAcw = true)]
  public class SerialInputOutputManager : Object, IRunnable, IJavaObject, IDisposable, IJavaPeerable
  {
    private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/commoniolib/SerialInputOutputManager", typeof (SerialInputOutputManager));
    private static Delegate? cb_getListener;
    private static Delegate? cb_setListener_Lcom_zebra_commoniolib_SerialInputOutputManager_Listener_;
    ...
    [Register(".ctor", "(Lcom/zebra/commoniolib/UsbSerialPort;)V", "")]
    public unsafe SerialInputOutputManager(IUsbSerialPort? serialPort)
      : base(IntPtr.Zero, (JniHandleOwnership) 0)
    {
      ...
      try
      {
        ...
        JniObjectReference instance = SerialInputOutputManager._members.InstanceMethods.StartCreateInstance("(Lcom/zebra/commoniolib/UsbSerialPort;)V", ((object) this).GetType(), jniArgumentValuePtr);
        this.SetHandle(((JniObjectReference) ref instance).Handle, (JniHandleOwnership) 1);
        SerialInputOutputManager._members.InstanceMethods.FinishCreateInstance("(Lcom/zebra/commoniolib/UsbSerialPort;)V", (IJavaPeerable) this, jniArgumentValuePtr);
      }
      finally
      {
    ...
    [Register(".ctor", "(Lcom/zebra/commoniolib/UsbSerialPort;Lcom/zebra/commoniolib/SerialInputOutputManager$Listener;)V", "")]
      ...
      : base(IntPtr.Zero, (JniHandleOwnership) 0)
    {
      ...
      try
      {
        ...
        JniObjectReference instance = SerialInputOutputManager._members.InstanceMethods.StartCreateInstance("(Lcom/zebra/commoniolib/UsbSerialPort;Lcom/zebra/commoniolib/SerialInputOutputManager$Listener;)V", ((object) this).GetType(), jniArgumentValuePtr);
        this.SetHandle(((JniObjectReference) ref instance).Handle, (JniHandleOwnership) 1);
        SerialInputOutputManager._members.InstanceMethods.FinishCreateInstance("(Lcom/zebra/commoniolib/UsbSerialPort;Lcom/zebra/commoniolib/SerialInputOutputManager$Listener;)V", (IJavaPeerable) this, jniArgumentValuePtr);
      }
      finally
      {
        GC.KeepAlive((object) serialPort);
    ...
    private static Delegate GetSetListener_Lcom_zebra_commoniolib_SerialInputOutputManager_Listener_Handler()
    {
      if ((object) SerialInputOutputManager.cb_setListener_Lcom_zebra_commoniolib_SerialInputOutputManager_Listener_ == null)
        SerialInputOutputManager.cb_setListener_Lcom_zebra_commoniolib_SerialInputOutputManager_Listener_ = JNINativeWrapper.CreateDelegate((Delegate) new _JniMarshal_PPL_V(SerialInputOutputManager.n_SetListener_Lcom_zebra_commoniolib_SerialInputOutputManager_Listener_));
      return SerialInputOutputManager.cb_setListener_Lcom_zebra_commoniolib_SerialInputOutputManager_Listener_;
    }

    private static void n_SetListener_Lcom_zebra_commoniolib_SerialInputOutputManager_Listener_(
      IntPtr jnienv,
      IntPtr native__this,
    ...
    {
      [Register("getListener", "()Lcom/zebra/commoniolib/SerialInputOutputManager$Listener;", "GetGetListenerHandler")] get
      {
        JniObjectReference jniObjectReference = SerialInputOutputManager._members.InstanceMethods.InvokeVirtualObjectMethod("getListener.()Lcom/zebra/commoniolib/SerialInputOutputManager$Listener;", (IJavaPeerable) this, (JniArgumentValue*) null);
      ...
      [Register("setListener", "(Lcom/zebra/commoniolib/SerialInputOutputManager$Listener;)V", "GetSetListener_Lcom_zebra_commoniolib_SerialInputOutputManager_Listener_Handler")] set
      {
        try
        {
          JniArgumentValue* jniArgumentValuePtr = stackalloc JniArgumentValue[1]
          ...
          SerialInputOutputManager._members.InstanceMethods.InvokeVirtualVoidMethod("setListener.(Lcom/zebra/commoniolib/SerialInputOutputManager$Listener;)V", (IJavaPeerable) this, jniArgumentValuePtr);
        }
        finally
        {
    ...
    [Register("getState", "()Lcom/zebra/commoniolib/SerialInputOutputManager$State;", "GetGetStateHandler")]
    public virtual unsafe SerialInputOutputManager.State? GetState()
    {
      JniObjectReference jniObjectReference = SerialInputOutputManager._members.InstanceMethods.InvokeVirtualObjectMethod("getState.()Lcom/zebra/commoniolib/SerialInputOutputManager$State;", (IJavaPeerable) this, (JniArgumentValue*) null);
    ...
    [Register("com/zebra/commoniolib/SerialInputOutputManager$Listener", "", "Com.Zebra.Commoniolib.SerialInputOutputManager/IListenerInvoker")]
    public interface IListener : IJavaObject, IDisposable, IJavaPeerable
    {
      [Register("onNewData", "([B)V", "GetOnNewData_arrayBHandler:Com.Zebra.Commoniolib.SerialInputOutputManager/IListenerInvoker, MauiJavaSdkBinding")]
      void OnNewData(byte[]? p0);

      [Register("onRunError", "(Ljava/lang/Exception;)V", "GetOnRunError_Ljava_lang_Exception_Handler:Com.Zebra.Commoniolib.SerialInputOutputManager/IListenerInvoker, MauiJavaSdkBinding")]
      void OnRunError(Exception? p0);
    }

    [Register("com/zebra/commoniolib/SerialInputOutputManager$Listener", DoNotGenerateAcw = true)]
    internal class IListenerInvoker : 
      ...
      IJavaPeerable
    {
      private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/commoniolib/SerialInputOutputManager$Listener", typeof (SerialInputOutputManager.IListenerInvoker));
      ...
      {
        return JNIEnv.IsInstanceOf(handle, SerialInputOutputManager.IListenerInvoker.java_class_ref) ? handle : throw new InvalidCastException("Unable to convert instance of type '" + JNIEnv.GetClassNameFromInstance(handle) + "' to type 'com.zebra.commoniolib.SerialInputOutputManager.Listener'.");
      }
    ...
    [Register("mono/com/zebra/commoniolib/SerialInputOutputManager_ListenerImplementor")]
    ...
    [Register("com/zebra/commoniolib/SerialInputOutputManager$State", DoNotGenerateAcw = true)]
    public sealed class State : Enum
    {
      private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/commoniolib/SerialInputOutputManager$State", typeof (SerialInputOutputManager.State));
      ...
      public static SerialInputOutputManager.State? Running
      {
        get
        {
          JniObjectReference objectValue = SerialInputOutputManager.State._members.StaticFields.GetObjectValue("RUNNING.Lcom/zebra/commoniolib/SerialInputOutputManager$State;");
      ...
      public static SerialInputOutputManager.State? Stopped
      {
        get
        {
          JniObjectReference objectValue = SerialInputOutputManager.State._members.StaticFields.GetObjectValue("STOPPED.Lcom/zebra/commoniolib/SerialInputOutputManager$State;");
          return Object.GetObject<SerialInputOutputManager.State>(((JniObjectReference) ref objectValue).Handle, (JniHandleOwnership) 1);
        }
      }
      ...
      public static SerialInputOutputManager.State? Stopping
      {
        get
        {
          JniObjectReference objectValue = SerialInputOutputManager.State._members.StaticFields.GetObjectValue("STOPPING.Lcom/zebra/commoniolib/SerialInputOutputManager$State;");
          return Object.GetObject<SerialInputOutputManager.State>(((JniObjectReference) ref objectValue).Handle, (JniHandleOwnership) 1);
        }
      }
      ...
      [Register("valueOf", "(Ljava/lang/String;)Lcom/zebra/commoniolib/SerialInputOutputManager$State;", "")]
      public static unsafe SerialInputOutputManager.State? ValueOf(string? name)
      {
        ...
        try
        {
          ...
          JniObjectReference jniObjectReference = SerialInputOutputManager.State._members.StaticMethods.InvokeObjectMethod("valueOf.(Ljava/lang/String;)Lcom/zebra/commoniolib/SerialInputOutputManager$State;", jniArgumentValuePtr);
          return Object.GetObject<SerialInputOutputManager.State>(((JniObjectReference) ref jniObjectReference).Handle, (JniHandleOwnership) 1);
        }
        finally
        {
      ...
      [Register("values", "()[Lcom/zebra/commoniolib/SerialInputOutputManager$State;", "")]
      public static unsafe SerialInputOutputManager.State[]? Values()
      {
        JniObjectReference jniObjectReference = SerialInputOutputManager.State._members.StaticMethods.InvokeObjectMethod("values.()[Lcom/zebra/commoniolib/SerialInputOutputManager$State;", (JniArgumentValue*) null);
