...
{
  [Register("com/zebra/rfid/api3/Util", DoNotGenerateAcw = true)]
  public class Util : Object
  {
    private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/rfid/api3/Util", typeof (Util));

    internal static IntPtr class_ref
    {
      get
      {
        JniObjectReference peerReference = Util._members.JniPeerType.PeerReference;
    ...
    public virtual JniPeerMembers JniPeerMembers => Util._members;
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    protected virtual Type ThresholdType => Util._members.ManagedPeerType;

    protected Util(IntPtr javaReference, JniHandleOwnership transfer)
      ...
      : base(IntPtr.Zero, (JniHandleOwnership) 0)
    {
      if (this.Handle != IntPtr.Zero)
        return;
      JniObjectReference instance = Util._members.InstanceMethods.StartCreateInstance("()V", ((object) this).GetType(), (JniArgumentValue*) null);
      this.SetHandle(((JniObjectReference) ref instance).Handle, (JniHandleOwnership) 1);
      Util._members.InstanceMethods.FinishCreateInstance("()V", (IJavaPeerable) this, (JniArgumentValue*) null);
    }
    ...
    public static unsafe Object? ConvertArrayToNibbleArray(Object? val)
    {
      try
      {
        ...
        JniObjectReference jniObjectReference = Util._members.StaticMethods.InvokeObjectMethod("ConvertArrayToNibbleArray.(Ljava/lang/Object;)Ljava/lang/Object;", jniArgumentValuePtr);
    ...
    public static unsafe Object? ConvertArrayToString(Object? val, string? type, string? format)
    {
      ...
      try
      {
        ...
        JniObjectReference jniObjectReference = Util._members.StaticMethods.InvokeObjectMethod("ConvertArrayToString.(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;", jniArgumentValuePtr);
        return Object.GetObject<Object>(((JniObjectReference) ref jniObjectReference).Handle, (JniHandleOwnership) 1);
      }
      finally
      {
    ...
    public static unsafe string? GetNodeValue(string[]? strArray, string? key)
    {
      ...
      try
      {
        ...
        JniObjectReference jniObjectReference = Util._members.StaticMethods.InvokeObjectMethod("GetNodeValue.([Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", jniArgumentValuePtr);
    ...
    public static unsafe string? GetNodeValue1(string[]? strArray, string? key)
    {
      ...
      try
      {
        ...
        JniObjectReference jniObjectReference = Util._members.StaticMethods.InvokeObjectMethod("GetNodeValue1.([Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", jniArgumentValuePtr);
        return JNIEnv.GetString(((JniObjectReference) ref jniObjectReference).Handle, (JniHandleOwnership) 1);
      }
      finally
      {
    ...
    public static unsafe string[]? GetNodes(string? strArray, string? key)
    {
      ...
      try
      {
        ...
        JniObjectReference jniObjectReference = Util._members.StaticMethods.InvokeObjectMethod("GetNodes.(Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;", jniArgumentValuePtr);
    ...
    public static unsafe bool IsNodePresent(string[]? strArray, string? key)
    {
      ...
      try
      {
        ...
        return Util._members.StaticMethods.InvokeBooleanMethod("IsNodePresent.([Ljava/lang/String;Ljava/lang/String;)Z", jniArgumentValuePtr);
      }
      finally
      {
        if (strArray != null)
    ...
    public static unsafe Object? ParseArrayFromString(string? val, string? type, string? format)
    {
      ...
      try
      {
        ...
        JniObjectReference jniObjectReference = Util._members.StaticMethods.InvokeObjectMethod("ParseArrayFromString.(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;", jniArgumentValuePtr);
        return Object.GetObject<Object>(((JniObjectReference) ref jniObjectReference).Handle, (JniHandleOwnership) 1);
      }
      finally
      {
    ...
    public static unsafe Object? ParseValueTypeFromString(string? val, string? type)
    {
      ...
      try
      {
        ...
        JniObjectReference jniObjectReference = Util._members.StaticMethods.InvokeObjectMethod("ParseValueTypeFromString.(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;", jniArgumentValuePtr);
        return Object.GetObject<Object>(((JniObjectReference) ref jniObjectReference).Handle, (JniHandleOwnership) 1);
      }
      finally
      {
    ...
    public static unsafe Object? ParseValueTypeFromString(string? val, string? type, string? format)
    {
      ...
      try
      {
        ...
        JniObjectReference jniObjectReference = Util._members.StaticMethods.InvokeObjectMethod("ParseValueTypeFromString.(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;", jniArgumentValuePtr);
        return Object.GetObject<Object>(((JniObjectReference) ref jniObjectReference).Handle, (JniHandleOwnership) 1);
      }
      finally
      {
    ...
    public static unsafe bool IsNullOrBlank(string? param)
    {
      ...
      try
      {
        ...
        return Util._members.StaticMethods.InvokeBooleanMethod("isNullOrBlank.(Ljava/lang/String;)Z", jniArgumentValuePtr);
      }
      finally
      {
