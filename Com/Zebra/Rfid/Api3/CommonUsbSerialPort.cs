...
// Type: Com.Zebra.Rfid.Api3.CommonUsbSerialPort
...
namespace Com.Zebra.Rfid.Api3
{
  ...
  public abstract class CommonUsbSerialPort : 
    ...
    IJavaPeerable
  {
    private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/rfid/api3/CommonUsbSerialPort", typeof (CommonUsbSerialPort));
    ...
    public static IRFIDLogger? Logger
    {
      get
      {
        JniObjectReference objectValue = CommonUsbSerialPort._members.StaticFields.GetObjectValue("LOGGER.Lcom/zebra/rfid/api3/IRFIDLogger;");
    ...
    public abstract IUsbSerialDriver? Driver { [Register("getDriver", "()Lcom/zebra/rfid/api3/UsbSerialDriver;", "GetGetDriverHandler")] get; }
