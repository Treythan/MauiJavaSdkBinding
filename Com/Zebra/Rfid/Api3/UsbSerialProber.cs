...
// Type: Com.Zebra.Rfid.Api3.UsbSerialProber
...
{
  [Register("com/zebra/rfid/api3/UsbSerialProber", DoNotGenerateAcw = true)]
  public class UsbSerialProber : Object
  {
    private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/rfid/api3/UsbSerialProber", typeof (UsbSerialProber));
    ...
    public static IRFIDLogger? Logger
    {
      get
      {
        JniObjectReference objectValue = UsbSerialProber._members.StaticFields.GetObjectValue("LOGGER.Lcom/zebra/rfid/api3/IRFIDLogger;");
    ...
    [Register(".ctor", "(Lcom/zebra/rfid/api3/ProbeTable;)V", "")]
      ...
      : base(IntPtr.Zero, (JniHandleOwnership) 0)
    {
      ...
      try
      {
        ...
        JniObjectReference instance = UsbSerialProber._members.InstanceMethods.StartCreateInstance("(Lcom/zebra/rfid/api3/ProbeTable;)V", ((object) this).GetType(), jniArgumentValuePtr);
        this.SetHandle(((JniObjectReference) ref instance).Handle, (JniHandleOwnership) 1);
        UsbSerialProber._members.InstanceMethods.FinishCreateInstance("(Lcom/zebra/rfid/api3/ProbeTable;)V", (IJavaPeerable) this, jniArgumentValuePtr);
      }
      finally
      {
    ...
    {
      [Register("getDefaultProbeTable", "()Lcom/zebra/rfid/api3/ProbeTable;", "")] get
      {
        JniObjectReference jniObjectReference = UsbSerialProber._members.StaticMethods.InvokeObjectMethod("getDefaultProbeTable.()Lcom/zebra/rfid/api3/ProbeTable;", (JniArgumentValue*) null);
    ...
    {
      [Register("getDefaultProber", "()Lcom/zebra/rfid/api3/UsbSerialProber;", "")] get
      {
        JniObjectReference jniObjectReference = UsbSerialProber._members.StaticMethods.InvokeObjectMethod("getDefaultProber.()Lcom/zebra/rfid/api3/UsbSerialProber;", (JniArgumentValue*) null);
    ...
    [Register("probeDevice", "(Landroid/hardware/usb/UsbDevice;)Lcom/zebra/rfid/api3/UsbSerialDriver;", "GetProbeDevice_Landroid_hardware_usb_UsbDevice_Handler")]
    public virtual unsafe IUsbSerialDriver? ProbeDevice(UsbDevice? usbDevice)
    {
      try
      {
        ...
        JniObjectReference jniObjectReference = UsbSerialProber._members.InstanceMethods.InvokeVirtualObjectMethod("probeDevice.(Landroid/hardware/usb/UsbDevice;)Lcom/zebra/rfid/api3/UsbSerialDriver;", (IJavaPeerable) this, jniArgumentValuePtr);
