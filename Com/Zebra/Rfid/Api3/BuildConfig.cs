...
// Type: Com.Zebra.Rfid.Api3.BuildConfig
...
{
  [Register("com/zebra/rfid/api3/BuildConfig", DoNotGenerateAcw = true)]
  public sealed class BuildConfig : Object
  {
    ...
    public const string LibraryPackageName = "com.zebra.rfid.api3";
    [Register("VERSION_CODE")]
    public const int VersionCode = 125;
    [Register("VERSION_NAME")]
    public const string VersionName = "2.0.3.148";
    private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/rfid/api3/BuildConfig", typeof (BuildConfig));
