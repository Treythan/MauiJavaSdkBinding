...
// Type: Com.Zebra.Rfid.Api3.IUsbSerialPortInvoker
...
namespace Com.Zebra.Rfid.Api3
{
  ...
  internal class IUsbSerialPortInvoker : 
    ...
    IJavaPeerable
  {
    private static readonly JniPeerMembers _members = (JniPeerMembers) new XAPeerMembers("com/zebra/rfid/api3/UsbSerialPort", typeof (IUsbSerialPortInvoker));
    ...
    {
      return JNIEnv.IsInstanceOf(handle, IUsbSerialPortInvoker.java_class_ref) ? handle : throw new InvalidCastException("Unable to convert instance of type '" + JNIEnv.GetClassNameFromInstance(handle) + "' to type 'com.zebra.rfid.api3.UsbSerialPort'.");
    }
    ...
    public IUsbSerialDriver? Driver
    {
      get
      {
        if (this.id_getDriver == IntPtr.Zero)
          this.id_getDriver = JNIEnv.GetMethodID(this.class_ref, "getDriver", "()Lcom/zebra/rfid/api3/UsbSerialDriver;");
